...
def update_report_readiness(manifest: dict[str, Any]) -> None:
    for report_type in REPORT_TYPES:
        ...
        manifest["report_readiness"][report_type] = {
            ...
            "collection_mode": pointer.get("collection_mode", "unknown"),
            "point_in_time_recovered": bool(pointer.get("point_in_time_recovered")),
            "schedule_delay_minutes": pointer.get("schedule_delay_minutes", 0),
