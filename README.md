...
- 观察池固定为 Core 10 只、Watch 14 只，另采集东威科技（688700），为唯一 locked；胜宏科技（300476）保留 Watch，locked=false。
- 均线包含 MA5、MA10、MA20、MA60；箱体包含最近 20 个交易日上沿、下沿和位置。
- BOLL(20,2)、KDJ(9,3,3)、MACD(12,26,9)提供实际计算参数、初始化方式、复权口径及指标日期；不宣称与任何终端完全一致。
